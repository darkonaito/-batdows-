...
echo set "winPlacePos=%winPlacePos%">"!Alt.Prog_D!engine\games\%gamen%\"%lvln%.bat
echo set "deaPlacePos=%deaPlacePos%">>"!Alt.Prog_D!engine\games\%gamen%\"%lvln%.bat
echo set "nexLvlPos=%nexLvlPos%">>"!Alt.Prog_D!engine\games\%gamen%\"%lvln%.bat
echo set "nexLvlN=%nexLvlN%">>"!Alt.Prog_D!engine\games\%gamen%\"%lvln%.bat
echo set "cols=%cols%">>"!Alt.Prog_D!engine\games\%gamen%\"%lvln%.bat
title Saving...

echo set "loc_y=%loc_y%">>"!Alt.Prog_D!engine\games\%gamen%\"%lvln%.bat
echo set "loc_x=%loc_x%">>"!Alt.Prog_D!engine\games\%gamen%\"%lvln%.bat
echo set "ptr_l=%ptr_l%">>"!Alt.Prog_D!engine\games\%gamen%\"%lvln%.bat

echo color %cols%>>"!Alt.Prog_D!engine\games\%gamen%\"%lvln%.bat
echo set "lvln=%lvln%">>"!Alt.Prog_D!engine\games\%gamen%\"%lvln%.bat
for /l %%i in (1,1,639) do ( 
if "!b%%i!"=="%skin%" set "b%%i= "
echo set "b%%i=!b%%i!">>"!Alt.Prog_D!engine\games\%gamen%\"%lvln%.bat
)
goto render
:savExit
title Saving...
...
echo  Games:
echo.
dir/b !Alt.Prog_D!engine\games\*
echo.
echo.
set/p gamen=
if not exist !Alt.Prog_D!engine\games\%gamen% (
	goto menu
) else (
	call "!Alt.Prog_D!engine\games\%gamen%\"ini.bat
)
:loadg2
if %locked%==True goto loadg
call !Alt.Prog_D!!gpat!
set "b!ptr_l!=%skin%"
goto render
:exit_2
set help=true
